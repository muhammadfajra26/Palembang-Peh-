...
<html>
<head>
    <title>Palembang Peh - "Paling lemak emang ke Palembang"</title>
...
<body>
    ...
    <header>
        ...
        <div class="tombolmasukdaftar">
            <ul>
                <li class="daftar"><a href="/daftar"><b>Daftar<b></a></li>
                <li class="masuk"><a href="/login"><b>Masuk<b></a></li>
            </ul>
        </div>
        ...
        <a href="/"><li class="lihatlainnya">Lihat Lainnya <img src="Assets/Img/Down.png" width="20px"></li></a>
        <div class="nama">
            <p><b>Foto :</b></p>
            <p><i>Jembatan Ampera</i></p>
        </div></br></br>
    </header>
    <div id="body" class="sedangramai">
        ...
        <ul>
            <li class="masjidchengho">
                <h3>1</h3>
                <a href="/"><img src="Assets/Img/Masjid.jpg"></a>
                <p>Masjid Cheng Ho</p>
            </li>
            <li class="pulaukemaro">
                <h3>2</h3>
                <a href="/"><img src="Assets/Img/Pulau.jpg"></a>
                <p>Pulau Kemaro</p>
            </li>
            <li class="ampera"> 
                <h3>3</h3>
                <a href="/"><img src="Assets/Img/ampera.jpg"></a>
                <p>Jembatan Ampera</p>
            </li>
        </ul>
    </div></br></br>
    <div class="wisatapalembang">
        <h2>WISATA PALEMBANG</h2>
        <hr size="7px" width="190px"></br>
        <ul>
            <li>
                <a href="/"><img src="Assets/Img/Benteng.jpg"></a>
                <p>Benteng Kuto Besak</p>
            </li>
            <li>
                <a href="/"><img src="Assets/Img/Alquran.jpg"></a>
                <p>AlQuran Al Akbar</p>
            </li>
            <li> 
                <a href="/"><img src="Assets/Img/Punti.jpg"></a>
                <p>Punti Kayu</p>
            </li><br>
            <li>
                <a href="/"><img src="Assets/Img/ampera.jpg"></a>
